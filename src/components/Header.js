...
class Header extends React.Component {
    ...
    render() {
        return <div className="header">
            ...
            <video id="videoHeader" src="/videoHeader.mp4" width="100%" height="100%" loop="true" muted={this.state.muteVideo} playsinline autoplay="true" preload="" controls={true} className="video"/>
        </div>
    }
}
